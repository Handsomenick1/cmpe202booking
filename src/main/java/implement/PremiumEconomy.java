...
public class PremiumEconomy implements CategoryStrategy {
    private Map<String, List<Flight>> flightMap;
    private List<String[]> result;
    private final List<String[]> seatList;

    public PremiumEconomy(Map<String, List<Flight>> flightMap) {
    ...
    public List<String[]> getprice() {
        for(Map.Entry<String, List<Flight>> entry : flightMap.entrySet()) {
            ...
            for(Flight flight : flights) {
                if (flight.getCategory().equals("Premium Economy")){
    ...
    public List<String[]> getseats() {
        for(Map.Entry<String, List<Flight>> entry : flightMap.entrySet()) {
            List<Flight> flights = entry.getValue();
            for(Flight flight : flights) {
                if (flight.getCategory().equals("PremiumEconomy")){
